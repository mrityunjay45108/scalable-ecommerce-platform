...
// ==========================================
// KAFKA EVENT STREAMING & ENVELOPE TYPES
// ==========================================
...
export const KafkaEventType = {
  ...
  // Payment & COD Events (Mapped into ecommerce.order.events)
  ...
  // Inventory Events (ecommerce.inventory.events)
  ...
  // E-Commerce Shipment Events (ecommerce.shipment.events)
  ...
  // Courier Shipment Events (courier.shipment.events)
...
export type KafkaEventType = (typeof KafkaEventType)[keyof typeof KafkaEventType];

export const KafkaConsumerGroup = {
  ORDER_WORKER: 'ecommerce-order-worker',
  INVENTORY_WORKER: 'ecommerce-inventory-worker',
  SHIPMENT_WORKER: 'ecommerce-shipment-worker',
} as const;
export type KafkaConsumerGroup = (typeof KafkaConsumerGroup)[keyof typeof KafkaConsumerGroup];
